...
st.set_page_config(page_title="Flanker Testi - Beta", layout="wide")
st.title("🧠 Flanker Testi (Beta 20 Hz Müzik ile)")
...
<audio id='bgAudio' loop>
  <source src='https://barisakar24.github.io/flanker-test/Beta_20Hz.wav' type='audio/wav'>
</audio>

<div id='startScreen'>
  <div id='startMessage'>
    🎧 20 Hz Beta müziğiyle dikkat testi.<br><br>
